...
dashboard.section.buttons.val = {
    button("f", " Find file", leader, ":Telescope find_files<CR>"),
    button("r", " Recent files", leader, ":Telescope oldfiles<CR>"),
    button("p", " Project find", leader, ":Telescope project<CR>"),
