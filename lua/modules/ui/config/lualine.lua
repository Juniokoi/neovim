local icons = {
	ui = require("misc.icons").get("ui", true),
}
...
local function lsp_colors()
	...
	if next(clients) == nil then return { fg = colors.red, gui = "bold" } end
	for _, client in ipairs(clients) do
		local filetypes = client.config.filetypes
		if filetypes and vim.fn.index(filetypes, buf_ft) ~= -1 then return { fg = colors.cyan, gui = "bold" } end
	end
end
...
ins_left({
	function() return "▊" end,
	color = mode_colors, -- Sets highlighting of component
